...
public class MongodbResultSet implements ResultSet {
	...
	public String getString(String columnLabel) throws SQLException {
		return (String) dbObject.get(columnLabel);
	}
	...
	public boolean getBoolean(int columnIndex) throws SQLException {
		...
		if( dbObj != null){
			...
			throw new SQLException(String.format("Can't read column '%s'.", columnIndex));
		}
	}
	...
	public boolean last() throws SQLException {
		...
		for(int i=0 ; i < skip ; i++){
			//--This if statement is needed in cases of the last pages where the actual items is smaller than the limit--
			if(dbCursor.hasNext()){
				dbObject = dbCursor.next();				
			}
		}
